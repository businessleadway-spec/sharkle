    ...
    <footer ref={ref} className="relative overflow-hidden bg-foreground">
      ...
      <div className="container mx-auto px-4 py-16 relative z-10">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <ScrollReveal animation="fade-up" className="lg:col-span-2">
            <a href="#" className="inline-flex items-center gap-3 mb-6 group">
              ...
              />
              <span className="text-2xl font-display font-bold text-white">Sharkle</span>
            </a>
            ...
            <div className="flex gap-3">
              <motion.a 
                ...
                className="w-11 h-11 rounded-xl bg-white/10 backdrop-blur-sm flex items-center justify-center text-white/70 hover:bg-white/20 hover:text-white transition-all duration-300 border border-white/10"
          ...
          <ScrollReveal animation="fade-up" delay={0.1}>
            <h4 className="font-display font-bold mb-6 text-white text-lg">Links</h4>
          ...
          <ScrollReveal animation="fade-up" delay={0.2}>
            <h4 className="font-display font-bold mb-6 text-white text-lg">Contato</h4>
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <motion.button 
            onClick={scrollToTop} 
            className="w-10 h-10 rounded-xl bg-white/10 backdrop-blur-sm flex items-center justify-center text-white/70 hover:bg-white/20 hover:text-white transition-all duration-300 border border-white/10" 
