      ...
      <div className="container mx-auto px-4 py-12">
          ...
          <div className="lg:col-span-2">
            <a href="#home" className="inline-block mb-4">
              <span className="text-2xl font-bold">
                ...
                <span className="text-foreground">etdeep</span>
              </span>
            </a>
            <p className="text-muted-foreground mb-4 max-w-md">
              Desde 2009 protegendo empresas de todos os tamanhos com soluções avançadas em cibersegurança.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                ...
                <span className="text-muted-foreground">16 3726 3961 / 3826 2006</span>
              </li>
              <li className="flex items-start gap-3">
                <Mail className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" />
                <a href="mailto:comercial@netdeep.com.br" className="text-muted-foreground hover:text-primary transition-colors">
                  comercial@netdeep.com.br
                </a>
              </li>
              <li className="flex items-start gap-3">
                <MapPin className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" />
                <span className="text-muted-foreground">Interior de São Paulo, Brasil</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-border mt-12 pt-8 text-center">
          <p className="text-muted-foreground text-sm">
            © {new Date().getFullYear()} Netdeep. Todos os direitos reservados.
          </p>
        </div>
      </div>
    </footer>
