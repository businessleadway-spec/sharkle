          ...
          <ScrollReveal animation="fade-up" className="lg:col-span-2">
            ...
            <div className="flex gap-3">
              <a 
                ...
                className="w-11 h-11 rounded-xl bg-white/10 flex items-center justify-center text-white/70 hover:bg-white/20 hover:text-white transition-all duration-300 hover:scale-105"
              >
