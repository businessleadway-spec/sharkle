...
const services = [
  {
    ...
    href: '#contato',
    cta: 'Saiba mais',
    className: "sm:col-span-1 lg:col-start-1 lg:col-end-2 lg:row-start-1 lg:row-end-3",
  ...
  },
  {
    ...
    href: '#contato',
    cta: 'Saiba mais',
    className: "sm:col-span-1 lg:row-start-1 lg:row-end-4 lg:col-start-2 lg:col-end-3",
  ...
  },
  {
    ...
    href: '#contato',
    cta: 'Saiba mais',
    className: "sm:col-span-1 lg:col-start-1 lg:col-end-2 lg:row-start-3 lg:row-end-4",
  ...
  },
  {
    ...
    href: '#contato',
    cta: 'Saiba mais',
    className: "sm:col-span-1 lg:col-start-3 lg:col-end-4 lg:row-start-1 lg:row-end-2",
  ...
  },
  {
    ...
    href: '#contato',
    cta: 'Saiba mais',
    className: "sm:col-span-1 lg:col-start-3 lg:col-end-4 lg:row-start-2 lg:row-end-4",
  ...
  },
  {
    ...
    href: '#contato',
    cta: 'Saiba mais',
    className: "sm:col-span-2 lg:col-start-1 lg:col-end-4 lg:row-start-4 lg:row-end-5",
